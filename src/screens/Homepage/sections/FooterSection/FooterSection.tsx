  ...
  return (
    <footer className=" w-full flex flex-col items-center gap-20 pt-[60px] pb-10 px-[72px] bg-white max-[1100px]:px-[50px] max-[1000px]:py-[40px] max-[680px]:px-[25px] max-[680px]:gap-5">
      <div className="flex flex-col gap-[60px] items-center w-full">
        ...
        <div className="flex w-full gap-[20px] max-w-[1296px] justify-between items-center max-[1100px]:flex-col max-[1100px]:gap-10">
          {/* Logo */}
          ...
          {/* Contact information */}
          <div>
          <div className="flex gap-10 justify-between max-w-[950px] max-[800px]:flex-wrap max-[800px]:justify-center max-[800px]:gap-5">
                {contactInfo.map((item, index) => (
            <div key={index} className="flex w-[220px] items-center gap-3">
              <div
        ...
        {/* Main footer content */}
        <div className="w-full max-w-[1296px] flex items-start justify-between gap-[20px] max-[1022px]:flex-wrap max-[680px]:justify-center">
          {/* Company description and social media */}
          <div className="flex flex-col w-[280px] items-start justify-between h-full">
            <div className="font-['Work_Sans',Helvetica] font-medium text-defaultblack text-sm leading-[21px]">
          ...
          {/* Useful links */}
          <div className="flex flex-col w-[180px] items-start gap-6 max-[680px]:items-center max-[500px]:gap-3">
            <div className="font-['Work_Sans',Helvetica] font-semibold text-defaultblack text-xl leading-normal max-[640px]:text-[14px]">
              Useful links
            </div>
            <div className="flex flex-col items-start gap-4 w-full max-[680px]:items-center max-[500px]:gap-2">
              {usefulLinks.map((link, index) => (
                <div
                  key={index}
                  className="font-['Work_Sans',Helvetica] font-normal text-defaultblack text-base leading-[26px] cursor-pointer max-[680px]:text-[14px]"
                >
                  {link}
                </div>
              ))}
          ...
          <div className="flex flex-col w-[180px] items-start gap-6 max-[500px]:w-[100%] max-[500px]:items-center">
            <div className="font-['Work_Sans',Helvetica] font-semibold text-defaultblack text-xl leading-normal">
              Download App
            </div>
      ...
      <div className="font-['Inter',Helvetica] font-normal text-[#00000080] text-sm leading-[26px] max-[500px]:text-[12px]">
